...
export default function BusinessCard4(){
  ...
  return <div>
    ...
    <div className="absolute top-0 left-0">
      ...
      <div className='absolute w-4/5 max-w-md bg-gradient-to-r from-green-400 to-blue-500 p-5'>
        <div className='border-4 border-[#fbbf24] rounded-lg p-5'>
          <div className='grid grid-cols-2 gap-2'>
            <div className='text-white flex justify-center'>
              <img className='h-32 w-32 rounded-full' src={img} />
            </div> 
            <div>
              <div className='font-bold text-2xl text-[#fbbf24] pb-3'>{username}</div>
              <div className='p-1'>
                <a className='flex' href={git} target="_blank">
                  <div className='h-6 w-6 rounded-full bg-white'>
                    <svg className='h-6 w-6' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                  ...
                  <div className='text-[#fefce8] text-base font-medium pl-3'>{username}</div>
                </a>
              </div>
              {twitter? 
                <div className='p-1'>
                  <a className='flex' href={`https://x.com/${twitter}?lang=en`} target="_blank">
                    <div className='h-6 w-6 rounded-full bg-white'>
                      <svg className='h-6 w-6' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/>
                      </svg>
                    </div>
                    <div className='text-[#fefce8] text-base font-medium pl-3'>{twitter}</div>
                  </a>
                </div>
                : <div></div>
              }
              {blog?
                <div className='p-1'>
                  <a className='flex' href={blog} target="_blank">
                    <div className='h-6 w-6 rounded-full bg-white flex justify-center p-0.5'>
                    ...
                    <div className='text-[#fefce8] text-base font-medium pl-3'>Blog</div>
                  </a>
                </div>
                : <div></div>
              }
