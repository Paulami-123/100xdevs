...
export default function BirthDayCard2(){
    ...
    return<div>
      <div className="h-screen flex items-center justify-center">
        <div className="relative w-1/3 bg-black text-white">
          ...
          src="https://marketplace.canva.com/EAFXiEAvaps/1/0/1131w/canva-pink-beige-watercolor-rose-wedding-flower-frame-page-border-9OfQlsLx56k.jpg" />
        </div>
        ...
        <div className="absolute w-1/5 text-center top-0 pt-48">
          ...
          <div className="font-dance font-bold text-[#059669] lg:text-2xl md:text-sm sm:text-xs">
            ...
            <div>I want to remind you that you're not only {age} years old, </div> 
            <div>but you're also {age} years wiser, 
            </div>
            <div>more awesome, and more loved.</div>
            <div>Happy birthday, friend!</div>
          </div>
        </div>
      </div>
    </div>
